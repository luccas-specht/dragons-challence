...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8401);
...
const DragonDetailsPage = () => {
  ...
  } = (0,_hooks__WEBPACK_IMPORTED_MODULE_4__/* .useGetDragonDetails */ .Yp)();
  const {
    0: isLoading,
    1: setIsLoading
  ...
  const getDragonDetails = async () => {
    ...
    await (0,_utils__WEBPACK_IMPORTED_MODULE_6__/* .fakeDelay */ .Em)(500);
    setIsLoading(false);
  };
  ...
  return /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx(_components__WEBPACK_IMPORTED_MODULE_5__/* .DragonDetailsTemplate */ .LY, {
    id: dragon.id,
    name: dragon.name,
    type: dragon.type,
    isLoading: isLoading,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DragonDetailsPage);
});
...
var __webpack_exports__ = __webpack_require__.X(0, [400,578,565,901], () => (__webpack_exec__(334)));
